...
<h2><?php echo __('Product Category'); ?></h2>
	<dl>
        ...
        <dt><?php echo __('is_active'); ?></dt>
        <dd>
            <?php echo h($productCategory['ProductCategory']['is_active']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Image'); ?>:</dt>
        <dd>
            <?php echo $this->Html->image('products/' . $productCategory['ProductCategory']['url'], array('border' => '0')); ?>
            &nbsp;
        </dd>
