...
<div class="products index">
	<h2><?php echo __('Products'); ?></h2>
        ...
        <?php
            echo $this->Form->input('category_id', array('options' => $productCategories, 'empty' => '-- All --'));
            echo $this->Form->submit('Submit', array('class' => ''));
        ?>
	...
	<tr>
		...
		<td><?php echo h($product['Product']['url']); ?>&nbsp;</td>
