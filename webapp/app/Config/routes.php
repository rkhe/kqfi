 ...
 */
	...
	Router::connect('/faq', array('controller' => 'pages', 'action' => 'display','faq'));
        Router::connect('/outlets', array('controller' => 'pages', 'action' => 'display','outlets'));
	Router::connect('/promo', array('controller' => 'posts', 'action' => 'promo'));
        Router::connect('/careers', array('controller' => 'posts', 'action' => 'careers'));
	Router::connect('/menuboard', array('controller' => 'ProductCategories', 'action' => 'index'));
